...
Cube::Cube()
{
	...
	glBufferData(GL_ELEMENT_ARRAY_BUFFER, 6 * 2 * 3 * sizeof(unsigned int), cubeIndex, GL_STATIC_DRAW);
    // 6 faces, cada uma com 2 triangulos e cada triangulo com 3 vertices
}
